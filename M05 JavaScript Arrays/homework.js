...
function promedioResultadosTest(resultadosTest) {
   ...
   for( i = 0; i < resultadosTest.length; i++){
      var suma = resultadosTest.reduce((a, b) => a + b);
...
function todosIguales(array) {
   ...
   // Tu código:
   var iguales = array.every(elemento => elemento === array[1])
   return iguales
}
...
function mesesDelAño(array) {
   ...
   // Tu código:
   var meses = array.filter(elemento => elemento === 'Enero' || elemento === 'Marzo' || elemento === 'Noviembre')
   if (meses.length === 3){
      return meses
   } else {
